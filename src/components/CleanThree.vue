...
//   const opacity = Math.abs(cameraPosition.y) - 4;
//   return opacity - 0.5;
// };

// const fourthGeometry = new BoxGeometry(1, 1, 1);
// const fourthMaterial = new MeshBasicMaterial({
//   color: 0xffff00,
//   transparent: true,
//   opacity: calculateOpacity(cameraPosition.z),
// });
...
const handleScroll = (event) => {
  ...
  // fourthMaterial.opacity = calculateOpacity(cameraPosition.y);
};
</script>
